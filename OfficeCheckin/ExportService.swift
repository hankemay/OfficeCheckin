...
enum ExportService {
    ...
    static func export(from context: ModelContext? = nil) throws -> URL {
        ...
        let parts = [
            ...
            "xl/workbook.xml": "<?xml version=\"1.0\"?><workbook xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\" xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\"><sheets><sheet name=\"Check-ins\" sheetId=\"1\" r:id=\"rId1\"/></sheets></workbook>",

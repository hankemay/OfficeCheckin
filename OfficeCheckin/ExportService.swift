...
enum ExportService {
    ...
    static func export(from context: ModelContext? = nil) throws -> URL {
        ...
        let sheetRows = data.enumerated().map { index, item in
            "<row r=\"\(index + 2)\"><c r=\"A\(index + 2)\" t=\"inlineStr\"><is><t>\(item.dayKey.xml)</t></is></c><c r=\"B\(index + 2)\" t=\"inlineStr\"><is><t>\(item.checkedInAt.formatted(date: .numeric, time: .standard).xml)</t></is></c><c r=\"C\(index + 2)\" t=\"inlineStr\"><is><t>\(item.ssid.xml)</t></is></c><c r=\"D\(index + 2)\" t=\"inlineStr\"><is><t>\(item.source.xml)</t></is></c><c r=\"E\(index + 2)\" t=\"inlineStr\"><is><t>\(employee)</t></is></c></row>"
        }.joined()
        let sheet = "<?xml version=\"1.0\"?><worksheet xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"><sheetData><row r=\"1\"><c r=\"A1\" t=\"inlineStr\"><is><t>Date</t></is></c><c r=\"B1\" t=\"inlineStr\"><is><t>Check-in Time</t></is></c><c r=\"C1\" t=\"inlineStr\"><is><t>Wi-Fi</t></is></c><c r=\"D1\" t=\"inlineStr\"><is><t>Source</t></is></c><c r=\"E1\" t=\"inlineStr\"><is><t>Employee Name</t></is></c></row>\(sheetRows)</sheetData></worksheet>"
        ...
        let weeklyRows = weekly.enumerated().map { index, group in
            ...
            return "<row r=\"\(row)\"><c r=\"A\(row)\" t=\"inlineStr\"><is><t>\(weekStart.xml)</t></is></c><c r=\"B\(row)\" t=\"inlineStr\"><is><t>\(group.value.count)</t></is></c><c r=\"C\(row)\" t=\"inlineStr\"><is><t>\(employee)</t></is></c></row>"
        }.joined()
        let weeklySheet = "<?xml version=\"1.0\"?><worksheet xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"><sheetData><row r=\"1\"><c r=\"A1\" t=\"inlineStr\"><is><t>Week Starting</t></is></c><c r=\"B1\" t=\"inlineStr\"><is><t>Check-ins</t></is></c><c r=\"C1\" t=\"inlineStr\"><is><t>Employee Name</t></is></c></row>\(weeklyRows)</sheetData></worksheet>"
        ...
        let summaryRows = summaries.enumerated().map { index, item in
            ...
            return "<row r=\"\(row)\"><c r=\"A\(row)\" t=\"inlineStr\"><is><t>\(item.title)</t></is></c><c r=\"B\(row)\" t=\"inlineStr\"><is><t>\(item.checkInCount)</t></is></c><c r=\"C\(row)\" t=\"inlineStr\"><is><t>\(item.workingDays)</t></is></c><c r=\"D\(row)\" t=\"inlineStr\"><is><t>\(average)</t></is></c><c r=\"E\(row)\" t=\"inlineStr\"><is><t>\(item.minimumCheckIns)</t></is></c><c r=\"F\(row)\" t=\"inlineStr\"><is><t>\(employee)</t></is></c></row>"
        }.joined()
        let summarySheet = "<?xml version=\"1.0\"?><worksheet xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"><sheetData><row r=\"1\"><c r=\"A1\" t=\"inlineStr\"><is><t>Quarter</t></is></c><c r=\"B1\" t=\"inlineStr\"><is><t>Check-ins</t></is></c><c r=\"C1\" t=\"inlineStr\"><is><t>Working Days</t></is></c><c r=\"D1\" t=\"inlineStr\"><is><t>Avg / Week</t></is></c><c r=\"E1\" t=\"inlineStr\"><is><t>Minimum Target</t></is></c><c r=\"F1\" t=\"inlineStr\"><is><t>Employee Name</t></is></c></row>\(summaryRows)</sheetData></worksheet>"
        let parts = [
    ...
    static func exportOperations(from context: ModelContext) throws -> URL {
        ...
        let rows = logs.enumerated().map { index, log in
            ...
            return "<row r=\"\(row)\"><c r=\"A\(row)\" t=\"inlineStr\"><is><t>\(timestamp.xml)</t></is></c><c r=\"B\(row)\" t=\"inlineStr\"><is><t>\(log.action.xml)</t></is></c><c r=\"C\(row)\" t=\"inlineStr\"><is><t>\(log.dayKey.xml)</t></is></c><c r=\"D\(row)\" t=\"inlineStr\"><is><t>\(employee)</t></is></c></row>"
        }.joined()
        let sheet = "<?xml version=\"1.0\"?><worksheet xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"><sheetData><row r=\"1\"><c r=\"A1\" t=\"inlineStr\"><is><t>Performed At</t></is></c><c r=\"B1\" t=\"inlineStr\"><is><t>Operation</t></is></c><c r=\"C1\" t=\"inlineStr\"><is><t>Check-in Date</t></is></c><c r=\"D1\" t=\"inlineStr\"><is><t>Employee Name</t></is></c></row>\(rows)</sheetData></worksheet>"
        let parts = [

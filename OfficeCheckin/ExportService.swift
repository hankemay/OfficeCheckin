...
enum ExportService {
    ...
    static func export(from context: ModelContext? = nil) throws -> URL {
        ...
        let sheet = "<?xml version=\"1.0\"?><worksheet xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"><sheetData><row r=\"1\"><c r=\"A1\" t=\"inlineStr\"><is><t>Date</t></is></c><c r=\"B1\" t=\"inlineStr\"><is><t>Check-in Time</t></is></c><c r=\"C1\" t=\"inlineStr\"><is><t>Wi-Fi</t></is></c></row>\(sheetRows)</sheetData></worksheet>"
        ...
        let parts = [
            ...
            "xl/workbook.xml": "<?xml version=\"1.0\"?><workbook xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\" xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\"><sheets><sheet name=\"Check-ins\" sheetId=\"1\" r:id=\"rId1\"/><sheet name=\"Quarterly Summary\" sheetId=\"2\" r:id=\"rId2\"/></sheets></workbook>",
